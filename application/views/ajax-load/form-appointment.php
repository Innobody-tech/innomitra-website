    ...
    <div class="section-content bg-white p-30">
      <div class="row">
        <div class="col-md-12">
          ...
          <form id="appointment_form_popup" name="appointment_form" class="appointment-form" method="post" action="http://html.thememascot.net/2021/health/medikx/medikx-html/ajax-load/includes/appointment.php">
            <h3 class="mt-0">Get A Service<span class="text-theme-colored1 font-weight-600"> Now!</span></h3>
            <p class="">Fill the Following Details</p>
            <div class="row">
              <div class="col-sm-6">
              ...
              <div class="col-sm-12">
                <div class="mb-3 mb-0 mt-0">
                  ...
                  <button type="submit" class="btn btn-theme-colored1 btn-round" data-loading-text="Please wait...">Submit</button>
                </div>
              </div>
            </div>
          </form>
